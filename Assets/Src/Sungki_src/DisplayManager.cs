...
public class DisplayManager : MonoBehaviour
{
    ...
    {
        textArray[0].transform.position = new Vector2(Screen.width / 2-20, Screen.height - 150);
        textArray[1].transform.position = new Vector2(Screen.width / 2, Screen.height - 350);
        textArray[2].transform.position = new Vector2(Screen.width / 2, Screen.height - 550);
